...
int main()
{
	const char* av_override[] = { "exe", "-c", "-v" }; //turn on verbose mode

	return CommandLineTestRunner::RunAllTests(3, av_override);
	return 0;
}
...
static void createWidgets(void) {
	...
	wi.g.x = 5; setbtntext(&wi, pagewidth, (char*)"Button 1");
	ghButton1 = gwinButtonCreate(0, &wi);
	wi.g.x += wi.g.width+3; setbtntext(&wi, pagewidth, (char*)"Button 2");
	ghButton2 = gwinButtonCreate(0, &wi);
	wi.g.x += wi.g.width+3; setbtntext(&wi, pagewidth, (char*)"Button 3");
	ghButton3 = gwinButtonCreate(0, &wi);
	wi.g.x += wi.g.width+3; setbtntext(&wi, pagewidth, (char*)"Button 4");
